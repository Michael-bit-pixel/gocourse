...
func main() {
	...
	secodnFlag := subcommand1.Int("bytes", 1024, "Byte length of result")

	flags2 := subcommand2.String("language", "Go", "Enter your language")
	...
	case "firstSub":
		...
		fmt.Println("bytes:", *secodnFlag)
	case "secondSub":
		subcommand2.Parse(os.Args[2:])
		fmt.Println("subCommand2:")
		fmt.Println("language:", *flags2)
	default:
